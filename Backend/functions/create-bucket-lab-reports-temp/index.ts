...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for lab-reports" ON storage.objects FOR SELECT USING (bucket_id = 'lab-reports');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for lab-reports" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'lab-reports');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for lab-reports" ON storage.objects FOR UPDATE USING (bucket_id = 'lab-reports');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for lab-reports" ON storage.objects FOR DELETE USING (bucket_id = 'lab-reports');`
    ];
